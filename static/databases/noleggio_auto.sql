...
--
-- Host: db_query:3306
-- Generation Time: May 04, 2025 at 05:43 AM
...
CREATE TABLE `Automobili` (
  ...
  `IdTipoAuto` varchar(15) NOT NULL
);
...
--
-- Dumping data for table `Incidenti`
--
...
(39, 1, "EZ012CD", 1, 25, "2024-05-10", "2024-05-15", 150.00, 320),
(40, 3, "EZ789CD", 1, 7, "2024-05-03", "2024-05-03", 180.00, 220),
(41, 3, "LX336CD", 17, 17, "2024-05-10", "2024-05-10", 180.00, 220);
...
--
-- Table structure for table `TipiAuto`
--

CREATE TABLE `TipiAuto` (
  `IdTipoAuto` varchar(100) NOT NULL,
  `CostoGiornaliero` decimal(10,2) NOT NULL,
  `CostoKm` decimal(10,2) NOT NULL
);

--
-- Dumping data for table `TipiAuto`
--
...
-- --
-- -- AUTO_INCREMENT for table `Incidenti`
-- --
-- ALTER TABLE `Incidenti`
...
-- --
-- ALTER TABLE `Noleggi`
--   MODIFY `IdNoleggio` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
-- --
-- -- Constraints for table `Incidenti`
-- --
-- ALTER TABLE `Incidenti`
